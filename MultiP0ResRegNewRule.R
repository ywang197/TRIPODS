...
p0 = 1   # number of selected features 
...
text(1000,16,"test error by using elastic net on the whole training set.", col="red")
plot(valid.err,ylim=c(0,30))
abline(h=test.err,col="red")
text(1000,18,"test error by using elastic net on the whole training set.", col="red")
